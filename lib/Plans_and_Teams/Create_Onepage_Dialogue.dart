...
class CreateOnepageDialogue extends StatefulWidget {
  final Function(String, String, String, String, String, String, List<String>, String) onCreateOnePagePlan;
  final List<String> strategies;
  final List<String> teams; // Pass teams list

  CreateOnepageDialogue({required this.onCreateOnePagePlan, required this.strategies, required this.teams});
