...
import '../controllers/plan_type_controller.dart';
import '../utils/showplaninfo.dart';


class plantype extends StatefulWidget {
  plantype({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _plantype  createState() => _plantype ();
}

class _plantype  extends State<plantype> {


  final plantypeController  _plantypeController  = Get.put(plantypeController ());
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton:  FloatingActionButton(
        onPressed: () async {
          await show_planInformationDialog(context);
        },
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: ListView.builder(
                ...
                itemCount: _plantypeController.plans.length,
                itemBuilder: (context, index) {
                  Plan plans = _plantypeController.plans[index];
                  return Container(
                    ...
                    child: Container(
                      ...
                      child: ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              _plantypeController.removetype(index);
                            });
                          },
                        ),
                      ),
