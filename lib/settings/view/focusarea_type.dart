...
import '../utils/focustypeform.dart';


class focusareatype extends StatefulWidget {
  focusareatype({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _focusareatype  createState() => _focusareatype ();
}

class _focusareatype  extends State<focusareatype> {


  final focustypeController  _focustypeController  = Get.put(focustypeController ());
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton:  FloatingActionButton(
        onPressed: () async {
          await show_focusInformationDialog(context);
        },
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: ListView.builder(
                ...
                itemCount: _focustypeController.focuses.length,
                itemBuilder: (context, index) {
                  Focusinfo focuses = _focustypeController.focuses[index];
                  return Container(
                    ...
                    child: Container(
                      ...
                      child: ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              _focustypeController.removetype(index);
                            });
                          },
                        ),
                      ),
