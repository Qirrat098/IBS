...
import '../controllers/project_type_controller.dart';
import '../utils/projecttypeform.dart';


class projecttype extends StatefulWidget {
  projecttype({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _projecttype createState() => _projecttype ();
}

class _projecttype  extends State<projecttype> {


  final projecttypeController _projecttypeController  = Get.put(projecttypeController ());
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton:  FloatingActionButton(
        onPressed: () async {
          await show_projectInformationDialog(context);
        },
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: ListView.builder(
                ...
                itemCount: _projecttypeController.projects.length,
                itemBuilder: (context, index) {
                  Projectinfo project = _projecttypeController.projects[index];
                  return Container(
                    ...
                    child: Container(
                      ...
                      child: ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              _projecttypeController.removetype(index);
                            });
                          },
                        ),
                      ),
