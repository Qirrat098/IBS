...
import '../view/plan_type.dart';




Future<void>  show_planInformationDialog(BuildContext context)async {
  return await showDialog(context: context,
      builder: (context) {
        String _selectedColorCode = '0x8533FFED';
        final _formKey = GlobalKey<FormState>();
        final plantypeController  _plantypeController  = Get.find();
        String? _name;
        //Color colorcode;
                    ...
                    children: [
                      ...
                      TextFormField(
                          decoration: const InputDecoration(
                            labelText: 'PLan type Name',
                            hintText: 'Enter Plan type  name',
                          ),

                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'Please enter a plan type name';
                            }
                            return null;
                          },
                          ...
                          ElevatedButton(
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                ...
                                _plantypeController .addtype(Plan(
                                  name: '$_name',
