...
import '../view/measure_type.dart';





Future<void>  show_measureInformationDialog(BuildContext context)async {
  return await showDialog(context: context,
      builder: (context) {
        String _selectedColorCode = '0x8533FFED';
        final _formKey = GlobalKey<FormState>();
        final measuretypeController  _measuretypeController  = Get.find();
        String? _name;
                    ...
                    children: [
                      ...
                      TextFormField(
                          decoration: const InputDecoration(
                            labelText: 'Measure Type Name',
                            hintText: 'Enter Measure Type name',
                          ),

                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'Please enter a Measure Type name';
                            }
                            return null;
                          },
                          ...
                          ElevatedButton(
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                ...
                                _measuretypeController.addmeasure(
                                  Measureinfo(
                                    name: '$_name',
