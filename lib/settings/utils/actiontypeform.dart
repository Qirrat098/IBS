...
import '../view/action_type.dart';



Future<void>  show_actionInformationDialog(BuildContext context)async {
  return await showDialog(context: context,
      builder: (context) {
        String _selectedColorCode = '0x8533FFED';
        final _formKey = GlobalKey<FormState>();
        final actiontypeController _actiontypeController = Get.find();
        String? _name;
        //Color colorcode;
                      ...
                      TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'Please enter a action name';
                            }
                            return null;
                          },
                          ...
                          ElevatedButton(
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                ...
                                _actiontypeController.addaction(
                                  Actioninfo(
                                  name: '$_name',
