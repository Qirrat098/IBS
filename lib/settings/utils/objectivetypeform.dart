...
import '../view/objective_type.dart';





Future<void>  show_objectiveInformationDialog(BuildContext context)async {
  return await showDialog(context: context,
      builder: (context) {
        String _selectedColorCode = '0x8533FFED';
        final _formKey = GlobalKey<FormState>();
        final objectivetypeController _objectivetypeController  = Get.find();
        String? _name;
        //Color colorcode;
                      ...
                      TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'Please enter a Objective name';
                            }
                            return null;
                          },
                          ...
                          ElevatedButton(
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                ...
                                _objectivetypeController .addobjectives(
                                Objectiveinfo(
                                    name: '$_name',
