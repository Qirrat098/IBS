...
import '../view/project_status.dart';



Future<void> showprojecttatusDialog(BuildContext context)async {
  return await showDialog(context: context,
      builder: (context){
        final _formKey = GlobalKey<FormState>();
        final  projectstatusController _projectstatusController= Get.find();
                      ...
                      TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'Please enter a project status';
                            }
                            return null;
                          },
                        ...
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) =>projectstatus(title: '',)),
                              );
                            },
                          ...
                          ElevatedButton(
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                ...
                                _projectstatusController.addproject(PStatus (
                                  name: '$_name',
