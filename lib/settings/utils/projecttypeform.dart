...
import '../view/project_type.dart';





Future<void>  show_projectInformationDialog(BuildContext context)async {
  return await showDialog(context: context,
      builder: (context) {
        String _selectedColorCode = '0x8533FFED';
        final _formKey = GlobalKey<FormState>();
        final projecttypeController _projecttypeController  = Get.find();
        String? _name;
        //Color colorcode;
                          ...
                          ElevatedButton(
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                ...
                                _projecttypeController.addprojects(
                                  Projectinfo(
                                    name: '$_name',
